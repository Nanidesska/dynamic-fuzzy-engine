import { e as createAstro, f as createComponent, r as renderTemplate, g as addAttribute, m as maybeRenderHead, s as spreadAttributes, h as renderSlot, i as renderComponent, j as renderHead } from '../astro_Offp8vsx.mjs';
import 'kleur/colors';
import 'clsx';
/* empty css                          */
/* empty css                                                                   */
...
const $$Astro$6 = createAstro("https://nani-sebastian.com");
const $$BaseHead = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$6, $$props, $$slots);
  Astro2.self = $$BaseHead;
  const canonicalURL = new URL(Astro2.url.pathname, Astro2.site);
  const { title, description, image = "/blog-placeholder-1.jpg" } = Astro2.props;
  return renderTemplate`<!-- Global Metadata --><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><link rel="icon" type="image/svg+xml" href="/favicon.svg"><meta name="generator"${addAttribute(Astro2.generator, "content")}><!-- Font preloads --><!-- <link rel="preload" href="/fonts/dancing-script-latin-700-normal.woff2" as="font" type="font/woff2" crossorigin /> --><!-- <link rel="preload" href="/fonts/dancing-script-latin-700-normal.woff" as="font" type="font/woff" crossorigin /> --><!-- Canonical URL --><link rel="canonical"${addAttribute(canonicalURL, "href")}><!-- Primary Meta Tags --><title>${title}</title><meta name="title"${addAttribute(title, "content")}><meta name="description"${addAttribute(description, "content")}><!-- Open Graph / Facebook --><meta property="og:type" content="website"><meta property="og:url"${addAttribute(Astro2.url, "content")}><meta property="og:title"${addAttribute(title, "content")}><meta property="og:description"${addAttribute(description, "content")}><meta property="og:image"${addAttribute(new URL(image, Astro2.url), "content")}><!-- Twitter --><meta property="twitter:card" content="summary_large_image"><meta property="twitter:url"${addAttribute(Astro2.url, "content")}><meta property="twitter:title"${addAttribute(title, "content")}><meta property="twitter:description"${addAttribute(description, "content")}><meta property="twitter:image"${addAttribute(new URL(image, Astro2.url), "content")}>`;
}, "/workspaces/WED/src/components/BaseHead.astro", void 0);

const $$Astro$5 = createAstro("https://nani-sebastian.com");
...
}, "/workspaces/WED/src/components/HeaderLink.astro", void 0);

const $$Astro$4 = createAstro("https://nani-sebastian.com");
...
}, "/workspaces/WED/src/components/Header.astro", void 0);

const $$Astro$3 = createAstro("https://nani-sebastian.com");
...
}, "/workspaces/WED/src/components/Footer.astro", void 0);

const $$Astro$2 = createAstro("https://nani-sebastian.com");
...
}, "/workspaces/WED/src/components/FormattedDate.astro", void 0);
...
const $$BlogPost = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`<html lang="en" data-astro-cid-bvzihdzo> <head>${renderComponent($$result, "BaseHead", $$BaseHead, { "title": title, "description": description, "data-astro-cid-bvzihdzo": true })}${renderHead()}</head> <body data-astro-cid-bvzihdzo> ${renderComponent($$result, "Header", $$Header, { "data-astro-cid-bvzihdzo": true })} <main data-astro-cid-bvzihdzo> <article data-astro-cid-bvzihdzo> <div class="prose" data-astro-cid-bvzihdzo> <div class="title" data-astro-cid-bvzihdzo> <div class="date" data-astro-cid-bvzihdzo> ${renderComponent($$result, "FormattedDate", $$FormattedDate, { "date": pubDate, "data-astro-cid-bvzihdzo": true })} ${updatedDate && renderTemplate`<div class="last-updated-on" data-astro-cid-bvzihdzo>
...
}, "/workspaces/WED/src/layouts/BlogPost.astro", void 0);

const $$Astro = createAstro("https://nani-sebastian.com");
const $$About = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro, $$props, $$slots);
  Astro2.self = $$About;
  return renderTemplate`${renderComponent($$result, "Layout", $$BlogPost, { "title": "About Me", "description": "Lorem ipsum dolor sit amet", "pubDate": /* @__PURE__ */ new Date("August 08 2021"), "heroImage": "/shooting 1.JPG" }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<p>
...
}, "/workspaces/WED/src/pages/about.astro", void 0);

const $$file = "/workspaces/WED/src/pages/about.astro";
const $$url = "/about";
...
export { $$HeaderLink as $, SITE_TITLE as S, SITE_DESCRIPTION as a, about as b };
