import { _ as __astro_tag_component__, F as Fragment, Y as createVNode } from './astro_Offp8vsx.mjs';
import { $ as $$Image } from './pages/generic_-ilNYQRj.mjs';
import { $ as $$HeaderLink } from './pages/about_nOUmUm63.mjs';
import 'clsx';
